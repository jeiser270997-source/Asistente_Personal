...
<file path="data/masterledger.json">
{
  "casos_legales": [
    {
      "id": "multa_itagui",
      "radicado": "0000430265",
      "estado": "Pendiente de impugnación",
      "entidad": "Secretaría de Movilidad Itagüí"
    }
  ]
}
</file>

<file path="data/perfil.md">
# Perfil Profesional de Jeiser

**Rol:** Auxiliar de Sistemas / QA Automation Engineer
**Skills:** Node.js, Playwright, Soporte IT, Mantenimiento de Hardware.
**Perfil Psicológico:** Proactivo, resolutivo, enfocado en automatizar procesos (LifeOS).
</file>
...
<file path="package.json">
{
  ...
  "scripts": {
    ...
    "brain": "node scripts/brain_orchestrator.js",
    "sensor": "node scripts/inbox_sensor.js",
    "cleaner": "node Herramientas/Gmail_Cleaner/cli.js"
  }
}
</file>
