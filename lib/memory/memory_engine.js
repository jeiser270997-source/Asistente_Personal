...
const DB_PATH = path.join(BASE_DIR, 'data', 'memoria_hipocampo.db');
const HECHOS_JSON_LEGACY = path.join(BASE_DIR, 'data', 'memoria', 'hechos.json');
const INDICE_JSON_LEGACY = path.join(BASE_DIR, 'data', 'memoria', 'indice.json');
