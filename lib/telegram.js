...
- [GUARDAR_NOTA: resumen del dato] -> Para recordar kilometrajes, fechas, ideas, etc.
- [NUEVA_TAREA: descripción] -> Para agregar algo a su To-Do list.
- [COMPLETAR_TAREA: ID] -> Para tachar una tarea terminada.
- [PREPARAR_CORREO] DESTINO: ... ASUNTO: ... CUERPO: ... [/PREPARAR_CORREO] -> Para redactar correos (ej. impugnaciones, CVs).
- [EJECUTAR_COMANDO: comando_powershell_o_cmd] -> Para revisar su PC, matar procesos, ver espacio en disco, etc.
