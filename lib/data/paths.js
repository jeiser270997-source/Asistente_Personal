...
const PATHS = {
  ...
  COMPUTRABAJO_STATE: path.join(DIR.STATE, 'computrabajo_state.json'),
  ...
  // ── Core data / Backups ──
  PROCESSED_EMAILS: path.join(DIR.DATA, 'processed_emails.json'),
  UHABITS_EXPORT:   path.join(DIR.BACKUPS, 'uhabits_export.csv'),
