...
const toolsDefinition = [
  ...
  },
  {
    ...
    function: {
      ...
      description: "Permite listar, añadir o marcar como completadas las tareas del sistema.",
      parameters: {
        type: "object",
        properties: {
          action: {
...
async function executeTool(name, args) {
  try {
    switch(name) {
      case 'buscar_memoria':
        return await mem0.getContexto(args.query, 1200) || "Sin memorias relevantes.";
      case 'scraper_web':
