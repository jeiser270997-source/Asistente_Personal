...
const CONTEXT_DIR = path.join(DATA_DIR, 'contexto_maestro');
...
class LobuloTemporal {
  ...
  // Cargar documentos y partirlos en "chunks" o fragmentos lógicos
  loadMemories() {
    this.memoryChunks = [];
    ...
    this.fuse = new Fuse(this.memoryChunks, {
      keys: ['text'],
      includeScore: true,
      threshold: 0.6 // Buscar similitud semántica parcial
    });
  }
