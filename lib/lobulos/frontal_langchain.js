...
const { parietalTool, memoriaTool, scraperTool, notasTool, pendingTool } = require('./parietal_langchain');
...
class LobuloFrontalLangChain {
  constructor() {
    ...
    this.llm       = buildLLM();
    this.tools     = [temporalTool, parietalTool, memoriaTool, scraperTool, notasTool, pendingTool];
