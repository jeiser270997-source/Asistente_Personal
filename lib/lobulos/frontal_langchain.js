...
function buildLLM() {
  if (process.env.DEEPSEEK_API_KEY) {
    console.log('[Frontal] LLM: deepseek-v4-flash (tool-calling via OpenAI compat)'); // Actualizado para evitar depreciación 24/07/2026
    return new ChatOpenAI({
      apiKey: process.env.DEEPSEEK_API_KEY,
      configuration: { baseURL: 'https://api.deepseek.com/v1' },
      model: 'deepseek-v4-flash', // Actualizado para evitar depreciación 24/07/2026
      temperature: 0.1,
      maxTokens: 2000,
    });
  }
