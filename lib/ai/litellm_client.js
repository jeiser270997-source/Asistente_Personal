...
async function getLLMClients(sensitive = false) {
  ...
  // ── 1. Google Gemini Direct API (Prioridad Principal con Gemini 3.6 Flash) ──
  if (googleKey) {
    const primaryModel = process.env.GOOGLE_GEMINI_MODEL || 'gemini-3.6-flash';
    ...
    c2._model = 'gemini-3-flash-preview';
    c2._provider = 'google';
    clients.push(c2);
  }
